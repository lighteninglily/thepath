...
export const ANNOUNCEMENT_TEMPLATES: SlideTemplate[] = [
  ...
  {
    id: 'announcement-photo-frame',
    name: 'Photo Frame',
    category: 'announcement',
    thumbnail: PLACEHOLDER_THUMB,
    description: 'Clean frame design for event photos',
    visualData: {
      backgroundGradient: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)',
      elements: [
        {
        ...
        },
        {
          id: 'details',
          type: 'text',
          content: 'Friday 7PM | Youth Center',
...

  {
    ...
    category: 'announcement',
    thumbnail: PLACEHOLDER_THUMB,
    description: 'Modern split layout with accent',
    visualData: {
  ...
  {
    id: 'announcement-badge-style',
    name: 'Badge Style',
    category: 'announcement',
    thumbnail: PLACEHOLDER_THUMB,
    description: 'Eye-catching badge design',
    visualData: {
...
export const SCRIPTURE_TEMPLATES: SlideTemplate[] = [
  ...
  {
    id: 'scripture-peaceful-blue',
    name: 'Peaceful Blue',
    category: 'scripture',
    thumbnail: PLACEHOLDER_THUMB,
    description: 'Calm, serene blue tones',
    visualData: {
  ...
  {
    id: 'scripture-nature-green',
    name: 'Nature Green',
    category: 'scripture',
    thumbnail: PLACEHOLDER_THUMB,
    description: 'Organic, earthy green theme',
    visualData: {
  ...
  {
    id: 'scripture-golden-light',
    name: 'Golden Light',
    category: 'scripture',
    thumbnail: PLACEHOLDER_THUMB,
    description: 'Warm, inspiring golden tones',
    visualData: {
  ...
  {
    id: 'scripture-minimalist-white',
    name: 'Minimalist White',
    category: 'scripture',
    thumbnail: PLACEHOLDER_THUMB,
    description: 'Clean, simple white design',
    visualData: {
